...
<div class="navbar navbar-default">
		<div class="container">	
			<div class="navbar-header">
				...
				<a  style="font-size:24pt; color:red" class="navbar-brand href="#">  Oriflame&nbsp&nbsp&nbsp</a>
			</div>
...
<div  style="padding-left:50px;padding-top:20px" id="bestCarousel" class="carousel slide" data-ride="carousel">

		<ol class="carousel-indicators">
			<li data-target="#bestCarousel" data-slide-to="0" class="active"> </li>
			<li data-target="#bestCarousel" data-slide-to="1"> </li>
			<li data-target="#bestCarousel" data-slide-to="2"> </li>
		</ol>
